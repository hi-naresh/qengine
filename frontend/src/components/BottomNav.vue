...
import { logout, hasFeature } from '../api'
...
const allMoreItems = [
  ...
  { to: '/brokers', label: 'Brokers', icon: BrokerIcon, feature: 'brokers' },
...
const moreItems = computed(() => allMoreItems.filter(i => !i.feature || hasFeature(i.feature)))
</script>
