...
See [PRE-SETUP.md](./PRE-SETUP.md) for detailed setup instructions.
...
|----------|-------------|
| [PRE-SETUP.md](./PRE-SETUP.md) | System requirements, database setup, environment configuration |
| [RUN.md](./RUN.md) | Starting the backend, frontend dev, Docker, CLI commands |
| [ARCHITECTURE.md](./ARCHITECTURE.md) | System architecture, directory structure, data flow |
| [HIGH-LEVEL-LOGIC.md](./HIGH-LEVEL-LOGIC.md) | How backtesting, optimization, Monte Carlo, and strategy execution work |
| [STRATEGY.md](./STRATEGY.md) | Complete strategy writing guide (basic to advanced) |
| [PROGRESS.md](./PROGRESS.md) | Development phases and roadmap |
...
See [STRATEGY.md](./STRATEGY.md) for the complete guide.
