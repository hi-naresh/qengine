...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, '03_session_analysis.png'), dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, '03_cooldown_analysis.png'), dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, '03_time_of_day.png'), dpi=150, bbox_inches='tight')
plt.close()
