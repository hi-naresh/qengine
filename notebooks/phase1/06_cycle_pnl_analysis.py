...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, '06_pnl_distribution.png'), dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, '06_equity_curve.png'), dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, '06_level_distribution.png'), dpi=150, bbox_inches='tight')
plt.close()
