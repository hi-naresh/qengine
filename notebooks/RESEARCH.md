# Grid-Hedged Martingale Tail-Risk Problem - Research

> **Leverage: 30:1** (all analysis, regenerated 2026-03-26). Scripts accept leverage as a parameter for 20:1 if needed.
...
| **Combined best config** (12 lvl, sqrt, 0.5%, % equity) | 10-13 | **VALIDATED** | 99.7% cycle win rate, 0.26% bust rate, PF 3.56, 0% ruin in 10k MC paths. Blind test OUTPERFORMS train. |
...
Minimum balance required (avg EUR-USD price ~1.112):

| Leverage | 5 levels (2x) | 6 levels (2x) | 7 levels (2x) |
|----------|---------------|---------------|---------------|
| **20:1** | — | — | **$70,709** |
| **30:1** | — | — | **$47,182** |
| 50:1 | — | — | $28,361 |

With sqrt sizing at 30:1, 7 levels needs far less. At $10k equity, sqrt(2) enables 11-12 levels vs only 6 for 2x.
...
|--------|--------|----------|---------|--------|-----|-------|--------|---------|-------|
| $10k / 0.5% / sqrt | 6,419 | **99.7%** | **0.26%** | 14.7% | **3.56** | -0.66% | 0.166 | 0.042 | 0.788 |
| $10k / 0.5% / 2x | 6,443 | 97.5% | 2.55% | 46.3% | 1.98 | -1.88% | 0.120 | 0.044 | 0.488 |
| $10k / 0.3% / sqrt | 6,418 | **99.9%** | **0.12%** | 8.9% | **3.91** | -0.53% | 0.154 | 0.038 | 0.828 |
| $10k / 1.0% / sqrt | 6,423 | 99.3% | 0.73% | 28.5% | 2.90 | -0.72% | 0.167 | 0.045 | 0.694 |
| $100k / 0.5% / sqrt | 6,419 | 99.7% | 0.26% | 14.7% | 3.56 | -0.66% | 0.166 | 0.042 | 0.788 |
| $1M / 0.5% / sqrt | 6,419 | 99.7% | 0.26% | 14.7% | 3.56 | -0.66% | 0.166 | 0.042 | 0.788 |

Critical findings:
- **99.7% win rate** with sqrt sizing (vs 92.5% with 5-level 2x)
...
- **Calmar ratio: 22.4** — exceptional risk-adjusted return
...
|--------|--------|--------|-----|-------|--------|
| 0.1% | 17 | 3.3% | 6.63 | -0.05% | 0.428 |
| 0.3% | 13 | 8.9% | 3.91 | -0.53% | 0.154 |
| **0.5%** | **12** | **14.7%** | **3.56** | **-0.66%** | **0.166** |
| 1.0% | 10 | 28.5% | 2.90 | -0.72% | 0.167 |
| 2.0% | 8 | 63.6% | 2.75 | -1.07% | 0.204 |
| 3.0% | 7 | 97.5% | 2.41 | -1.97% | 0.196 |
...
- At 0.1% base, Sharpe is highest (0.43) with nearly zero drawdown but only 3.3% return
...
|--------|---------|---------------|-------------|-----------|-----------|
| $10k / 0.5% / sqrt | **0.00%** | +4.4% | **100%** | 0.4% | 0.7% |
| $10k / 0.5% / 2x | 0.00% | +12.6% | 100% | 1.1% | 1.8% |
| $10k / 0.3% / sqrt | 0.00% | +2.7% | 100% | 0.3% | 0.5% |
| $100k / 0.5% / sqrt | 0.00% | +4.4% | 100% | 0.4% | 0.7% |
| $1M / 0.5% / sqrt | 0.00% | +4.4% | 100% | 0.4% | 0.7% |
...
|--------|-----------|------------|----------------|--------------|-------------|
| 5 lvl / 2x | +0.00850% | -0.05563% | **6.5x** | -0.191% | 22.5 wins |
| 7 lvl / 2x | +0.01213% | -0.23194% | **19.1x** | -0.723% | 59.6 wins |
| 12 lvl / sqrt | +0.00272% | -0.21451% | **78.9x** | -0.460% | 169.1 wins |
| 12 lvl / sqrt / 0.3% | +0.00163% | -0.12871% | **78.9x** | -0.276% | 169.1 wins |
| 12 lvl / sqrt / 1.0% | +0.00544% | -0.42902% | **78.9x** | -0.919% | 169.1 wins |
...
|--------|---------|------------|---------|----------|---------------|
| 5 lvl / 2x | 0.0746 | -0.056% | 0.00415 | +0.0037% | 1.8x |
| 7 lvl / 2x | 0.0255 | -0.232% | 0.00590 | +0.0059% | 2.0x |
| 12 lvl / sqrt | 0.0026 | -0.215% | 0.00057 | +0.0021% | **4.7x** |
...
|----------|---------|--------------|-----------|-----------|-------------|
| Normal | 0.0% | +4.4% | +3.3% | 0.4% | **100%** |
| 2x Bust Rate | 0.0% | +2.0% | +0.3% | 0.7% | **97.4%** |
| 2x Bust Severity | 0.0% | +2.7% | +0.6% | 0.9% | **98.1%** |
| **2x Rate + 2x Severity** | **0.0%** | **-1.8%** | **-4.9%** | **2.8%** | **14.6%** |
| **Worst 25% of Data** | **0.0%** | **-4.9%** | **-6.8%** | **5.0%** | **0.0%** |
| Zero Expectancy | 0.0% | +0.04% | -1.0% | 0.7% | 53.1% |
| Negative Expectancy | 0.0% | -4.2% | -5.2% | 4.2% | 0.0% |

Key takeaways:
- **Normal + single stress factor**: Strategy survives comfortably
- **Double stress (2x rate + 2x severity)**: Median return goes NEGATIVE. Only 14.6% of paths profitable. This is the danger zone.
- **Worst-quartile regime**: Total destruction — 0% profitable paths, median -4.9%
...
- **No single bust exceeds 0.46% of equity** — survivable individually
- **Final equity: $11,474** (+14.7%) despite all 17 busts
...
| | Profit Factor | 2.17 | **21.83** | Test BETTER |
| | Total Return | 2.90% | **7.48%** | Test BETTER |
| | Max Drawdown | -0.764% | **-0.178%** | Test BETTER |
| | Sharpe | 0.060 | **0.544** | Test BETTER |
| 7 lvl / 2x / 0.5% | Win Rate | 97.87% | **98.62%** | Consistent |
| | Bust Rate | 2.13% | **1.38%** | Test BETTER |
| | PF | 1.79 | **3.08** | Test BETTER |
| | Return | 8.67% | **20.45%** | Test BETTER |
| 5 lvl / 2x / 0.5% | Win Rate | 93.76% | **94.98%** | Consistent |
| | Bust Rate | 6.24% | **5.03%** | Test BETTER |
| | PF | 2.18 | **2.49** | Consistent |
...
|---|---|---|
| Normal market | Works well (+4.4% median MC) | Works well |
| Single stress factor | Survives (+2.0%) | Survives better |
| Double stress | **FAILS** (median -1.8%, only 14.6% profitable) | Could halt trading |
...
|---|---|---|---|
| EV per cycle | +0.0021% | Positive but thin | YES — P5 (entry quality) |
...
| P(ruin) double stress | 0.00% (but -1.8% median) | Survives but bleeds | YES — P6 (regime detection) |
