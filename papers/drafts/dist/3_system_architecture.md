...
The GA operator rates above (crossover 0.7, mutation 0.2, mutation σ = 0.05, tournament k = 3, elitism = 2) are widely used defaults in the genetic-algorithm literature (Eiben & Smith, 2015) and were not tuned in this work; sensitivity analysis to GA hyperparameters is identified as future work.
