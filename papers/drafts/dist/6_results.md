...
All §6 numerical results come from Iteration 1 on 2025–2026 data through the corrected qengine engine. Iteration 2 (§3.4.1 Table 3) is implementation-complete but **not** the model that produced §6.1.
...
**Comparison systems.** GTSBotPilot and FinRLPilot are re-run on the canonical OOS window and engine in Table 5. The four-way ordering — IslandPilot ≪ FinRL ≪ GTSBot ≪ Baseline on net loss and max drawdown — is analysed in §6.7 and §7.5; equity and drawdown trajectories appear in Figures 5–7.
