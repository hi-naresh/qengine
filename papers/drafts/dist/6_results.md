...
**Why the baseline loses 87.4%.** The baseline operates with a random entry signal (signal_mode='none', long_only) under a 20-pip hedge distance, max 5 depth levels, and sizing factor 1.7. A depth-5 bust costs approximately 13.7 base units (geometric sum of 1, 1.7, 2.89, 4.91, 8.35 scaled by the sizing curve). Across 1,619 sessions, 272 busts occur (16.8% bust rate), with 271 reaching depth 5 (Table 4 in Section 6.4). These deep busts contribute -$12,784 to the gross loss denominator, overwhelming the +$4,323 in gross profit from depths 0 to 4 and driving net equity from $10,000 to $1,262.
