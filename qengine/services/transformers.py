...
from qengine.enums import live_session_statuses
from qengine.repositories import order_repository, live_session_repository
...
def get_backtest_session_for_load_more(session: BacktestSession) -> dict:
    ...
    # Pipeline stats are loaded on-demand via /pipeline-stats-full endpoint (too large for main response)
