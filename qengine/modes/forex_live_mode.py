"""
Forex/CFD Live Trading Mode.
Replaces qengine_live for forex brokers (OANDA, IG Markets, IBKR).
Manages the live trading loop: price streaming, strategy execution,
