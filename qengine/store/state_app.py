...
class AppState:
    def __init__(self):
        ...
        # peak tracking for hedging/risk metrics
        self.worst_floating_pnl = 0.0
        self.peak_margin_used = 0.0
        self.peak_equity_usage_pct = 0.0

        # per-session tracking: { session_num: { max_float, min_float, peak_margin, peak_equity_pct, margin_block_leg } }
        self.session_stats = {}
