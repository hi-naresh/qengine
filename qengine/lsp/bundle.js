...
var QENGINE_ROOT = args["qengine-root"];
...
function startPyrightBridge() {
  if (!PYRIGHT_WS_PORT || !BOT_ROOT || !QENGINE_ROOT) {
    console.error("Error: --port and --bot-root and --qengine-root are required");
    console.error("Usage: npx tsx index.ts --port <PORT> --bot-root <BOT_ROOT> --qengine-root <QENGINE_ROOT>");
    process.exit(1);
  }
  deployPyrightConfig();
